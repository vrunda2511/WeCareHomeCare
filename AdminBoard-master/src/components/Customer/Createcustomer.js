...
handleSubmit(event) {
  event.preventDefault()
    if (event.target.customerfirstname.value == "" || event.target.customerlastname.value == "" || event.target.customergender.value == "" || event.target.customermobileno.value == "" ||  event.target.customeraddress.value =="" ||  event.target.customerarea.value == "" ||  event.target.customercity.value == "" || event.target.customeremail.value == "" || event.target.customerpassword.value == "" || event.target.customercpassword.value == "") {
            ...
            <div className="container">
              <Row>
                <Col sm={6}>
                  ...
                  <FormControl variant="outlined" controlId="gender" style={{width:350,marginBottom:10}}>
