...
import Termandconditions from "./termandconditions-model.component";
...
export default function SignUp() {
    ...
    function handleSubmit(event) {
        ...
        if (firstName == null || lastName == null || gender == null || mobileno == null || address == null || area == null || city == null || email == null || password == null || cpassword == null) {
            ...
            fetch(Constant.API_URL+"/Signup", requestOptions)
                ...
                .then(result => {
                    ...
                    if (result.status === "Success") {
                        ...
                        if (result.status === "Fail") {
                            toast.warn('Email is alredy exist!! ', {
                                position: "top-center",
                                autoClose: 5000,
                                hideProgressBar: false,
                                closeOnClick: true,
                ...
                <div className={classes.paper} style={{marginTop:0}}>
                    ...
                    <form className={classes.form} noValidate onSubmit={(e) => { e.preventDefault(); handleSubmit() }}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
              <FormControlLabel
                control={<Checkbox value="allowExtraEmails" onClick={onchecked} color="primary" defaultChecked style={{marginTop:5}}/>}
                                        
              />
             <span>I have read and accept the <Link onClick={() => setModalShow(true)}>terms & conditions*</Link></span>
            </Grid>
                        </Grid>
                        <Button
                            type="submit"
